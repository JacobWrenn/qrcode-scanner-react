...
export default function Scanner(_a) {
    ...
    var tracks = useRef([]);
    function play() {
        var videoElement = video.current;
    ...
    useEffect(function () {
        ...
        function scanQR() {
            return __awaiter(this, void 0, void 0, function () {
                var canvasElement, context, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            context === null || context === void 0 ? void 0 : context.drawImage(videoElement, 0, 0, canvasElement.width, canvasElement.height);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, , 4]);
                            _a = scanSuccess;
                            return [4 /*yield*/, scanner.scan(canvasElement)];
                        case 2:
        ...
        var teardown = function () {
            ...
            if (tracks.current.length > 0) {
                videoElement.pause();
                for (var _i = 0, _a = tracks.current; _i < _a.length; _i++) {
                    var track = _a[_i];
                    track.stop();
                }
            }
